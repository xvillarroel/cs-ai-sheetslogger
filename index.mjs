...
export const handler = async (event, context) => {
    ...
    console.log(eventObject.body.sheetid)
    console.log('************************************')
    ...
    let sheetid = eventObject.body.sheetid;
    let tabName = (!eventObject.body.tab) ? getCurrentDate(true) : eventObject.body.tab; //get the the DD/MM/YYYY
    let message = eventObject.body.message;
